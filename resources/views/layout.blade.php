...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('images/default_profile.png') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
        ...
        <footer class="main-footer">
            <strong>{{ __('text.DevelopedBy') }}: Danilo Urdaneta, 2020.</strong>
            danilourdaneta95@gmail.com.
        </footer>
